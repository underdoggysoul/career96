...
function check(form)/*function to check userid & password*/
{
 ...
 if(form.user.value == "company" && form.pass.value == "company")
  {
	window.location.href = "company.html";
	return true;
  }
  else if(form.user.value === "student" && form.pass.value === "student")
  {
...
$('.header-btn-area a').on('click', function (e) {
  ...
  $('.tab-contents > div').not(target).hide();
...
$(document).ready(function(){
    $("#bt1").click(function(){
        $("#t1").hide();
		$("#t2").addClass("rows").removeClass("hide");
    });
	$("#bt2").click(function(){
        $("#j1").hide();
		$("#j2").addClass("rows").removeClass("hide");
    });
});